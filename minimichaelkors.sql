...
-- ----------------------------
INSERT INTO `lr_indeximg` VALUES ('3', '0', '积分兑换', 'UploadFiles/category/indeximg/1504930032214587.png', '3', 'jifen', 'other');
INSERT INTO `lr_indeximg` VALUES ('2', '0', '当季新品', 'UploadFiles/category/indeximg/1504930004473379.png', '2', 'newpro', 'other');
INSERT INTO `lr_indeximg` VALUES ('1', '0', '全部商品', 'UploadFiles/category/indeximg/1504929992103294.png', '1', 'allpro', 'other');
INSERT INTO `lr_indeximg` VALUES ('4', '0', '品牌故事', 'UploadFiles/category/indeximg/1504930050110524.png', '4', 'brand', 'other');
...
CREATE TABLE `lr_product` (
  ...
  `start_time` int(11) DEFAULT NULL COMMENT '优惠券开始时间',
...
-- ----------------------------
INSERT INTO `lr_program` VALUES ('1', '骨刺鞋 懒洋洋', '', '骨刺鞋 懒洋洋', 'UploadFiles/logo/1501669240147747.png', 'Copyright © 2017骨刺鞋', '', '', '1508665640');
...
-- Records of lr_web
-- ----------------------------
INSERT INTO `lr_web` VALUES ('1', '0', '关于我们', '', null, null, '0', '<p></p><p><span style=\"font-family:宋体;font-size:10.5000pt;\"></span></p><div class=\"sonConBox \" style=\"margin: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: arial, sans-serif; font-size: 14px;\"><div class=\"h2_content\" style=\"margin: 0px; padding: 0px;\"><p style=\"margin: 0px 0px 15px; padding: 0px; line-height: 24px; text-indent: 2em; zoom: 1;\">1996年夏天，回湘东老家休假的罗建平先生在刚播种的秧田里发现了一个有趣的现象，几只偷吃稻种的小鸡在稀软的秧田上惊慌地扑腾着翅膀，它们每一步踩下去都会陷进泥里，而旁边明显体重更大的鸭子却能轻松地行走。鸭子的脚蹼增大了脚的承重面积，所以不会陷进泥里。其时，罗先生的母亲正在承受脚跟骨刺的折磨。作为一个鞋型设计师，罗建平先生很想为母亲研制一种能减缓脚部疼痛的鞋子。鸭子的脚蹼触动了他的灵感，在同等的压力下，受力面积越大压强越小，<span style=\"text-indent: 2em;\">骨刺之所以会痛，并不是骨刺本身痛，而是骨刺压迫了受力位置的肌肉和神经造成疼痛。</span></p><p style=\"margin: 0px 0px 15px; padding: 0px; line-height: 24px; text-indent: 2em; zoom: 1;\"><span style=\"text-indent: 2em;\">能否逆向思维找到一个方法，让鞋子的鞋底能够全面且均衡地承托脚底，达到分散压力的目的，改变传统鞋子只能前掌和后跟两点受力的问题?通过上千次实验，罗建平先生研发了一种柔软的弹性鞋底材料，这种材料能够依从不同的脚底弧度均衡地承托人的体重，减缓足跟骨刺的疼痛。</span></p></div></div><p></p>', '1508669105');
INSERT INTO `lr_web` VALUES ('3', '0', '首页视频管理', 'UploadFiles/vedio/20171009/vedio_4381507546425.mp4', 'http://player.56.com/v_MTQ3MDA1ODMx.swf', 'UploadFiles/vedio/20170803/vedio_8401501724293.png', '0', null, '1508230164');
